#ifndef PSTRINGMATCHING_SIMILARITY_MEASURE_GENERALIZED_JACCARD_HPP
#define PSTRINGMATCHING_SIMILARITY_MEASURE_GENERALIZED_JACCARD_HPP
...
namespace __pstringmatching_impl {
  template <class T>
